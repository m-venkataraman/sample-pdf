...
df_items['IMPORT PO NUMBER'] = import_po_number
df_items['DEAL'] = deal
...
df_items['EXITING COUNTRY'] = exiting_country
...
with pd.ExcelWriter("Hs4_data.xlsx", engine='xlsxwriter') as writer:
    ...
    print(f"Data for buyer {buyer} has been saved to Hs4_data.xlsx")
